...
public class BookRestController {
	...
	public ResponseEntity<Book> updateBook(@PathVariable long id, @RequestBody BookDTO updatedBook) {
		...
		//He modificado esta clase para pasar al método un argumento de tipo BookDTO y así proteger la integridad de Book
		Book persistentBook = new Book();
		persistentBook.setTitle(updatedBook.getTitle());
		persistentBook.setDescription(updatedBook.getDescription());
		if (service.exist(id)) {
